...
_______,   CW_COC,   CW_CAC,  _______,  SC_IJ_R,  SC_IJ_T,  _______,  _______,  _______,  _______,  _______,  _______,    _______,                      _______,  _______,  _______,  _______,    _______,  \
_______,   CW_SNC,  _______,  _______,  _______,  SC_IJ_G,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,  _______,  _______,  _______,              \
